...
"""
Note: Please fill the following with the appropriate keys before executing this file.
"""

ACCESS_KEY = os.getenv('TIO_TEST_REWIRED_FLAG_ENABLED_ACCESS', '')
SECRET_KEY = os.getenv('TIO_TEST_REWIRED_FLAG_ENABLED_SECRET', '')
...
"""
The following test functions invoke the Tenable APIs via the pyTenable SDK.
"""
